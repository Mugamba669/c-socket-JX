...
char *process_operation(char *input)
{
    ...
    // memcpy(output, "A chosen", 25);
    //return "A chosen";
     //strcpy(output, "A choosen");
    //      memcpy(output, "B chosen", 25);
    // return output;
    // }
    // else{
    //     //memcpy(output, "Another chosen", 25);
    //     //return "B choosen";
    //     strcpy(output, "B choosen");
    //     return output;
    // }

    char *output = malloc(20);
    // if(input[0]=='A'){
    // //strcpy(output,"A My friend");
    
    // }
    // else{
    //     //strcpy(output, "B choosen");
    //          memcpy(output,"B choosen", 24);
    //     return output;
    // }
    switch (input[0])
    {
    ...
    while (1)
    {
        ...
        if (pid == 0)
        {
            ...
            while (1)
            {
                ...
                // if(response == "A"){
                  send(client_fd,response, 200, 0);

                // }
                // else{
                //      send(client_fd,"You choose b", strlen(response), 0);
